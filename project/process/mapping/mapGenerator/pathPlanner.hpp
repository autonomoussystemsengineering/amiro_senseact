...
private:
	void dijstra(cv::Point2i robotCell, float direction, const cv::Mat &om, std::vector<cv::Point2i> &path, std::vector<cv::Point2i> otherposes = {});
	...
	static const int mapWidth = 600, mapHeight = 600;
};
